				...
				case "image":			
					...
					switch($arr_wall['step'])
					{
						case "uploadimage":							
							...
							break;
						case "onthewall":
							$contentStr = "发送成功！<a href = \"http://tangxueer.duapp.com/wall.php\">进入网页微信墙</a>再次发送请直接回复，若要退出微信墙功能请输入0。";
							$resultStr = $this->transmitText($postObj,$contentStr,$funcFlag=0);
...
/*数据库结束*/
            ...
            case "CLICK":
                switch ($object->EventKey)
                {
                    ...
                    case "underground":
                        ...
                        "Description" =>"点击查看大图", 
                        "PicUrl" =>"http://o6uv51311.bkt.clouddn.com/image/underground.jpg", 
                        "Url" =>"http://o6uv51311.bkt.clouddn.com/image/underground.jpg");
                        break;
					case "timetable":
						$contentStr[] = array("Title" =>"信工四班课表", 
                        "Description" =>"点击查看大图", 
                        "PicUrl" =>"http://o6uv51311.bkt.clouddn.com/image/timetable.png", 
                        "Url" =>"http://o6uv51311.bkt.clouddn.com/image/timetable.png");
						break;
					case "wall":
					...
					case "music":
						...
						"MusicUrl" => "http://o6uv51311.bkt.clouddn.com/music/music.mp3",
						"HQMusicUrl" => "http://o6uv51311.bkt.clouddn.com/music/music.mp3");						
						$type="music";				
						break;
					case "drama":
						$contentStr[] = array("Title" =>"BBC电视剧 神探夏洛克", 
                        "Description" =>"大英腐国三集片 主演：Benedict Cumberbatch & Martin Freeman (点击跳转B站链接)", 
                        "PicUrl" =>"http://o6uv51311.bkt.clouddn.com/image/drama.jpg", 
                        "Url" =>"http://www.bilibili.com/video/av722138/");
                        break;
					case "advice":
						$contentStr = "您将进行意见反馈，请输入您的意见！若不进行反馈，输入0退出。";
						$type="advice";
						break;
					case "contact":
	...
	public function forecast()
	{
		...
		if($weather == "晴"){$picurl="http://o6uv51311.bkt.clouddn.com/image/qing.jpg";}else
		if($weather == "多云"){$picurl="http://o6uv51311.bkt.clouddn.com/image/duoyun.jpg";}else
		if($weather == "阴"){$picurl="http://o6uv51311.bkt.clouddn.com/image/yin.jpg";}else
		if($weather == "暴风"||$weather=="台风"){$picurl="http://o6uv51311.bkt.clouddn.com/image/baofentaifen.jpg";}else
		if($weather == "暴雨"){$picurl="http://o6uv51311.bkt.clouddn.com/image/baoyu.jpg";}else
		if($weather == "冰雹"){$picurl="http://o6uv51311.bkt.clouddn.com/image/bingbao.jpg";}else
		if($weather == "雷阵雨"){$picurl="http://o6uv51311.bkt.clouddn.com/image/leizhenyu.jpg";}else
		if($weather == "雾"||$weather=="霾"){$picurl="http://o6uv51311.bkt.clouddn.com/image/wumai.jpg";}else
		if($weather == "小雪"||$weather=="中雪"||$weather=="大雪"){$picurl="http://o6uv51311.bkt.clouddn.com/image/xiaoxuedaxuezhongxue.jpg";}else
		if($weather == "雨夹雪"){$picurl="http://o6uv51311.bkt.clouddn.com/image/yujiaxue.jpg";}else
		if($weather == "小雨"||$weather=="中雨"||$weather=="大雨"||$weather=="阵雨"){$picurl="http://o6uv51311.bkt.clouddn.com/image/xiaoyuzhongyudayuzhenyu.jpg";}
		
		if($weather1 == "晴"){$picurl1="http://o6uv51311.bkt.clouddn.com/image/qing.jpg";}else
		if($weather1 == "多云"){$picurl1="http://o6uv51311.bkt.clouddn.com/image/duoyun.jpg";}else
		if($weather1 == "阴"){$picurl1="http://o6uv51311.bkt.clouddn.com/image/yin.jpg";}else
		if($weather1 == "暴风"||$weather=="台风"){$picurl1="http://o6uv51311.bkt.clouddn.com/image/baofentaifen.jpg";}else
		if($weather1 == "暴雨"){$picurl1="http://o6uv51311.bkt.clouddn.com/image/baoyu.jpg";}else
		if($weather1 == "冰雹"){$picurl1="http://o6uv51311.bkt.clouddn.com/image/bingbao.jpg";}else
		if($weather1 == "雷阵雨"){$picurl1="http://o6uv51311.bkt.clouddn.com/image/leizhenyu.jpg";}else
		if($weather1 == "雾"||$weather1=="霾"){$picurl1="http://o6uv51311.bkt.clouddn.com/image/wumai.jpg";}else
		if($weather1 == "小雪"||$weather1=="中雪"||$weather1=="大雪"){$picurl1="http://o6uv51311.bkt.clouddn.com/image/xiaoxuedaxuezhongxue.jpg";}else
		if($weather1 == "雨夹雪"){$picurl="http://o6uv51311.bkt.clouddn.com/image/yujiaxue.jpg";}else
		if($weather1 == "小雨"||$weather1=="中雨"||$weather1=="大雨"||$weather1=="阵雨"){$picurl1="http://o6uv51311.bkt.clouddn.com/image/xiaoyuzhongyudayuzhenyu.jpg";}
		
		if($weather2 == "晴"){$picurl2="http://o6uv51311.bkt.clouddn.com/image/qing.jpg";}else
		if($weather2 == "多云"){$picurl2="http://o6uv51311.bkt.clouddn.com/image/duoyun.jpg";}else
		if($weather2 == "阴"){$picurl2="http://o6uv51311.bkt.clouddn.com/image/yin.jpg";}else
		if($weather2 == "暴风"||$weather2=="台风"){$picurl2="http://o6uv51311.bkt.clouddn.com/image/baofentaifen.jpg";}else
		if($weather2 == "暴雨"){$picurl2="http://o6uv51311.bkt.clouddn.com/image/baoyu.jpg";}else
		if($weather2 == "冰雹"){$picurl2="http://o6uv51311.bkt.clouddn.com/image/bingbao.jpg";}else
		if($weather2 == "雷阵雨"){$picurl2="http://o6uv51311.bkt.clouddn.com/image/leizhenyu.jpg";}else
		if($weather2 == "雾"||$weather2=="霾"){$picurl2="http://o6uv51311.bkt.clouddn.com/image/wumai.jpg";}else
		if($weather2 == "小雪"||$weather2=="中雪"||$weather2=="大雪"){$picurl2="http://o6uv51311.bkt.clouddn.com/image/xiaoxuedaxuezhongxue.jpg";}else
		if($weather2 == "雨夹雪"){$picurl2="http://o6uv51311.bkt.clouddn.com/image/yujiaxue.jpg";}else
		if($weather2 == "小雨"||$weather2=="中雨"||$weather2=="大雨"||$weather2=="阵雨"){$picurl2="http://o6uv51311.bkt.clouddn.com/image/xiaoyuzhongyudayuzhenyu.jpg";}
	...
	public function nba()
	{
		...
		for($i = 1;$i <= 7;$i++)
		{
			...
			$now = date("Y年m月d日");
			$week = date("w");		
			if($week == 0){$week = "Sun";}else
			if($week == 1){$week = "Mon";}else
			if($week == 2){$week = "Tue";}else
			if($week == 3){$week = "Wed";}else
			if($week == 4){$week = "Thu";}else
			if($week == 5){$week = "Fri";}else
			if($week == 6){$week = "Sat";}
			$now = $now." ".$week;
	...
	public function nba_tom()
	{
		...
		for($i = 1;$i <= 7;$i++)
		{
			...
			$week = date("w");		
			if($week == 0){$week = "Mon";}else
			if($week == 1){$week = "Tue";}else
			if($week == 2){$week = "Wed";}else
			if($week == 3){$week = "Thu";}else
			if($week == 4){$week = "Fri";}else
			if($week == 5){$week = "Sat";}else
			if($week == 6){$week = "Sun";}
			$tom = $tom." ".$week;
